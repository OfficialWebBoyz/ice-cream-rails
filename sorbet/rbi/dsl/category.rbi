...
class Category
  ...
  module GeneratedAssociationMethods
    # This method is created by ActiveRecord on the `Category` class because it declared `has_many :flavor, through: :flavor_category`.
    # 🔗 [Rails guide for `has_many_through` association](https://guides.rubyonrails.org/association_basics.html#the-has-many-through-association)
    sig { returns(::Flavor::PrivateCollectionProxy) }
    def flavor; end

    sig { params(value: T::Enumerable[::Flavor]).void }
    def flavor=(value); end

    # This method is created by ActiveRecord on the `Category` class because it declared `has_many :flavor_category`.
